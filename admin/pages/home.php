...
class page {
	...
	public function content() { # Displays the page 
        ...
        if($updateInfo['devTime']) {
			...
			if(isset($r)) { $updatemsg = "<a target=\"_blank\" style=\"text-decoration:none;\" href=\"https://github.com/TheHostingTool/TheHostingTool/commit/$r\"><span style='color:green'>".substr($r, 0, 10)."</span></a>"; }
        }
