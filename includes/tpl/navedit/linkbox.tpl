		...
		<div class="portlet-content">
			...
			<table>
				<tr>
					...
					<td><input size="28" class="inputClass" type="text" name="name" value="%NAME%" id="inputName-%ID%" /></td>
				...
				<tr>
					...
					<td><input size="28" class="inputClass" type="text" class="tooltip" name="icon" value="%ICON%" id="inputIcon-%ID%" /></td>
				...
				<tr>
					...
					<td><input size="28" class="inputClass" type="text" class="tooltip" name="link" value="%LINK%" id="inputLink-%ID%" /></td>
